...
public class JurisprudenceSearchTest extends BaseTest {
	...
	@Test(priority = 1, groups = { "chpmex", "chparg", "chppy", "chpury","chppe" }, description = "MAFQABANG-68")
	...
	@Test(priority = 2, groups = { "chparg", "chppy", "chpury" ,"chppe"}, description = "MAFQABANG-425")
