...
public class SearchUsingHomePageTest extends BaseTest {
	...
	@Test(priority = 6, groups = { "chpury", "chppy" }, description = "MAFQABANG-502")
	...
	@Test(priority = 7, groups = { "chpury", "chppy","chppe","chpchile"}, description = "MAFQABANG-506")
	...
	@Test(priority = 17, groups = { "chpury", "chppy" }, description = "MAFQABANG-516")
