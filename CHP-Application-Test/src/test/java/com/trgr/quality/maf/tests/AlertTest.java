...
public class AlertTest extends BaseTest {
	 ...
	 */
	@Test(priority = 0, groups = { "chparg", "chpmex", "chpury", "chppy" }, description = "MAFAUTO-173")
	 ...
	 */
	@Test(priority = 0, groups = { "chparg", "chpmex", "chpury", "chppy" }, description = "MAFAUTO-225")
	...
	@Test(priority = 1, groups = { "chparg", "chpmex", "chpury", "chppy", "chpchile" }, description = "MAFQABANG-110")
	...
	// previous test
	@Test(priority = 2,dependsOnMethods={"createAnAlert"}, groups = { "chparg", "chpmex", "chpury", "chppy","chpchile" }, description = "MAFQABANG-113")
	...
	@Test(priority = 3,dependsOnMethods={"createAnAlert"}, groups = { "chparg","chpury", "chppy","chpchile"}, description = "MAFQABANG-620")
	...
	@Test(priority = 4,dependsOnMethods={"createAnAlert"}, groups = { "chparg", "chpmex", "chpury", "chppy" ,"chpchile"}, description = "MAFQABANG-111")
	...
	@Test(priority = 5, groups = { "chparg", "chpmex", "chpury", "chppy" }, description = "MAFQABANG-114")
	...
	@Test(priority = 6,dependsOnMethods={"createAnAlert"}, groups = { "chparg", "chpury", "chppy","chpchile" }, description = "MAFQABANG-112")
	...
	@Test(priority = 31, groups = { "chppy", "chpury" }, description = "MAFQABANG-551")
