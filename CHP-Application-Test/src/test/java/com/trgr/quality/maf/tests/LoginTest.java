...
public class LoginTest extends BaseTest {
	 ...
	 * 
	 */
	@Test(priority = 0, groups = { "chparg", "chpury", "chpmex", "chpbr", "chppy" ,"chppe","chpchile"}, description = "MAFQABANG-32")
	 ...
	 */
	@Test(priority = 0, groups = { "chparg", "chpury", "chppy" ,"chppe","chpchile"}, description = "MAFQABANG-35")
	...
	@Test(priority = 1, groups = { "chparg", "chpury", "chpmex", "chpbr", "chppy","chppe","chpchile" }, description = "MAFQABANG-45")
...
//			Thread.sleep(2000);
	...
	@Test(priority = 2, groups = { "chparg", "chpury", "chppy","chppe","chpchile" }, description = "MAFQABANG-37")
	...
	@Test(priority = 4, groups = { "chparg", "chpury","chppy","chppe","chpchile"}, description = " ")
	...
	@Test(priority = 12, groups = { "chpury", "chparg", "chppy","chppe","chpchile" }, description = "MAFQABANG-542")
	...
	@Test(priority = 13, groups = { "chppy","chpury" }, description = "MAFQABANG-579")
