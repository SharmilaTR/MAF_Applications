...
public class HomeTest extends BaseTest {
	...
	@Test(priority = 15, groups = { "chppy", "chpury" }, description = "MAFQABANG-475")
	...
	@Test(priority = 16, groups = { "chppy", "chpury" }, description = "MAFQABANG-482")
	...
	@Test(priority = 17, groups = { "chppy", "chpury" }, description = "MAFQABANG-483")
	...
	@Test(priority = 18, groups = { "chppy" }, description = "MAFQABANG-484")
	public void WidgetsforContabilidadThematicArea() throws Exception {
		SoftAssert softas = new SoftAssert();
		HomePage homepage = this.homepage;
		try {
			testResult = Reporter.getCurrentTestResult();
			...
			String jiraNumber = testResult.getMethod().getDescription();
			String issueSummary = getIssueTitle(jiraNumber,
					"Homepage widget verification post Contabilidad Thematic dropdown selected");
			String key = "thematic_area_value";
			String thematic_area_value = "Contabilidad y Auditoria";
			homepage.clickOnProductLogo();
			homepage.selectGivenValueFromThematicDropdown(thematic_area_value);

			iswidgetverified = homepage.verifywidgetsinhomepageforContabilidadThematicArea();
			softas.assertTrue(iswidgetverified, jiraNumber + ":" + issueSummary);
			logExtentStatus(extentLogger, iswidgetverified, issueSummary, key, thematic_area_value, jiraNumber);
		} catch (Exception exc) {
			logTestExceptionToExtentLogger(testResult.getMethod().getMethodName(), exc, extentLogger);
	...
	@Test(priority = 19, groups = { "chppy", "chpury" }, description = "MAFQABANG-486")
	 ...
	 * Thematic Area
	 */
	@Test(priority = 29, groups = { "chpury", "chppy" }, description = "MAFQABANG-565")
	...
	@Test(priority = 20, groups = { "chppy", "chpury" }, description = "MAFQABANG-487")
	...
	@Test(priority = 21, groups = { "chppy", "chpury" }, description = "MAFQABANG-492")
	...
	@Test(priority = 22, groups = { "chppy", "chpury" }, description = "MAFQABANG-495")
	...
	@Test(priority = 23, groups = { "chppy", "chpury" }, description = "MAFQABANG-496")
...
//				homepage = alertpage.clickHomeTab();
	...
	@Test(priority = 24, groups = { "chppy" }, description = "MAFQABANG-497")
	public void ShortcutsWidgetZeroEntryMessage() throws Exception {
		SoftAssert softas = new SoftAssert();
		HomePage homepage = this.homepage;
		try {
			testResult = Reporter.getCurrentTestResult();
			...
			String issueSummary = getIssueTitle(jiraNumber, "Shortcut widget zero record message verification");
			JSONArray listOfSearchData = jsonReader.readJSONDataFromFile(jiraNumber, extentLogger);
			...
			for (Object searchString : listOfSearchData) {
				...
				homepage.clickOnProductLogo();
				homepage.SelectThematicareadropdowns(thematicarea);
				if (homepage.isShortcutsWidgetMaximized()) {
					homepage.maximizeShortcutsWidget();
				}

				ismsgverified = homepage.isZeroShortcutsMessageDisplayed(message);
	...
	@Test(priority = 25, groups = { "chppy" }, description = "MAFQABANG-498")
	public void ShortcutsWidgetClickHereUrlVerification() throws Exception {
		SoftAssert softas = new SoftAssert();
		HomePage homepage = this.homepage;
		try {
			testResult = Reporter.getCurrentTestResult();
			...
			String issueSummary = getIssueTitle(jiraNumber,
					"Redirected url verification when Click Here for Shortcuts widget is clicked");
			JSONArray listOfSearchData = jsonReader.readJSONDataFromFile(jiraNumber, extentLogger);
			...
			for (Object searchString : listOfSearchData) {
				...
				homepage.closeAllChildTabs();
				homepage.clickOnShortcutsWidgetClickHere();
				urlverified = homepage.isRedirectedUrlEquals(expectedurl);
				softas.assertTrue(urlverified, jiraNumber + ":" + issueSummary);
				logExtentStatus(extentLogger, urlverified, issueSummary, expectedurlKey, expectedurl, jiraNumber);
			}
	...
	@Test(priority = 26, groups = { "chppy" }, description = "MAFQABANG-507")
	public void validateClientServiceWidget() throws Exception {
		SoftAssert softas = new SoftAssert();
		HomePage homepage = this.homepage;
		try {
			testResult = Reporter.getCurrentTestResult();
			extentLogger = setUpExtentTest(extentLogger, "HomePage", testResult.getMethod().getMethodName());
			boolean phnoverified = false;
			boolean emailverified = false;

			String jiraNumber = testResult.getMethod().getDescription();

			String issueSummary = getIssueTitle(jiraNumber,
					"Client Services widget contact number and email verification");
			JSONArray listOfSearchData = jsonReader.readJSONDataFromFile(jiraNumber, extentLogger);
			...
			for (Object searchString : listOfSearchData) {
				...
				String contactnoKey = "contact_no";
				String contactno = jsonReader.readKeyValueFromJsonObject(jsonObjectChild, contactnoKey, extentLogger);
				String contactemailKey = "contact_email";
				String contactemail = jsonReader.readKeyValueFromJsonObject(jsonObjectChild, contactemailKey,
						extentLogger);
				String thematicareaKey = "thematicarea";
				String thematicarea = jsonReader.readKeyValueFromJsonObject(jsonObjectChild, thematicareaKey,
						extentLogger);
				homepage.clickOnProductLogo();
				homepage.SelectThematicareadropdowns(thematicarea);
				boolean iscltservicewidgetmaximized = homepage.isClientServiceWidgetMaximized();
				if (iscltservicewidgetmaximized) {
					phnoverified = homepage.verifyClientServiceContactNum(contactno);
					emailverified = homepage.verifyClientServiceEmail(contactemail);
				} else {
					homepage.maximizeClientServiceWidget();
					phnoverified = homepage.verifyClientServiceContactNum(contactno);
					emailverified = homepage.verifyClientServiceEmail(contactemail);

				}

				softas.assertTrue(phnoverified && emailverified, jiraNumber + ":" + issueSummary);
				logExtentStatus(extentLogger, phnoverified && emailverified, issueSummary,
						contactnoKey + "," + contactemailKey, contactno + "," + contactemail, jiraNumber);
			}
	...
	@Test(priority = 27, groups = { "chppy", "chpury" }, description = "MAFQABANG-522")
	...
	@Test(priority = 28, groups = { "chppy", "chpury" }, description = "MAFQABANG-529")
	...
	@Test(priority = 29, groups = { "chppy" }, description = "MAFQABANG-533")
	public void AdvanceSearchWidgetForTodasThematicOption() throws Exception {
		SoftAssert softas = new SoftAssert();
		HomePage homepage = this.homepage;
		try {
			testResult = Reporter.getCurrentTestResult();
			...
			String issueSummary = getIssueTitle(jiraNumber, "Verify Search Links available in Advance Search Widget");
			...
			for (Object searchString : listOfSearchData) {
				...
				JSONArray expectedlinksArray = jsonReader.readJSonArrayFromJsonObject(jsonObjectChild, expectedlinksKey,
						extentLogger);
				...
				boolean linkverified = false;
				for (int row = 0; row < expectedlinksArray.size(); row++) {
					linkverified = homepage.advSearchLinkDisplayed(expectedlinksArray.get(row).toString());
					if (!linkverified)
						break;
				}

				softas.assertTrue(linkverified, jiraNumber + ":" + issueSummary);
				logExtentStatus(extentLogger, linkverified, issueSummary, expectedlinksKey,
						expectedlinksArray.toString(), jiraNumber);
			}
	...
	@Test(priority = 30, groups = { "chppy" }, description = "MAFQABANG-537")
	public void AdvanceSearchWidgetForFiscalThematicOption() throws Exception {
		SoftAssert softas = new SoftAssert();
		HomePage homepage = this.homepage;
		try {
			testResult = Reporter.getCurrentTestResult();
			...
			String issueSummary = getIssueTitle(jiraNumber,
					"Verify Advance search Links available for Fiscal Thematic drop down value");
			JSONArray listOfSearchData = jsonReader.readJSONDataFromFile(jiraNumber, extentLogger);
			...
			for (Object searchString : listOfSearchData) {
				...
				for (int row = 0; row < linksArray.size(); row++) {
					linkverified = homepage.advSearchLinkDisplayed(linksArray.get(row).toString());
					if (!linkverified)
						break;
				}

				softas.assertTrue(linkverified, jiraNumber + ":" + issueSummary);
				logExtentStatus(extentLogger, linkverified, issueSummary, linksKey, linksArray.toString(), jiraNumber);
			}
	...
	@Test(priority = 30, groups = { "chppy" }, description = "MAFQABANG-540")
	public void AdvanceSearchWidgetForContabilidadThematicOption() throws Exception {
		SoftAssert softas = new SoftAssert();
		HomePage homepage = this.homepage;
		try {
			testResult = Reporter.getCurrentTestResult();
			...
			String issueSummary = getIssueTitle(jiraNumber,
					"Verify Advance search Links available for Contabilidad y Auditoria Thematic drop down value");
			JSONArray listOfSearchData = jsonReader.readJSONDataFromFile(jiraNumber, extentLogger);
	...
	@Test(priority = 31, groups = { "chppy" }, description = "MAFQABANG-541")
	public void LinksAvailableunderFrequentlyAskedQuestions() throws Exception {
		SoftAssert softas = new SoftAssert();
		HomePage homepage = this.homepage;
		try {
			testResult = Reporter.getCurrentTestResult();
			...
			String issueSummary = getIssueTitle(jiraNumber,
					"Verify Frequently Asked Questions Links available for Todas Thematic drop down value");
			JSONArray listOfSearchData = jsonReader.readJSONDataFromFile(jiraNumber, extentLogger);
			...
			for (Object searchString : listOfSearchData) {
				...
				homepage.clickOnProductLogo();
				homepage.SelectThematicareadropdowns(thematicarea);
				boolean isfreqaskedqueswidgetmaximized = homepage.isFreqAskedQuestionsWidgetMaximized();
	...
	@Test(priority = 31, groups = { "chppy" }, description = "MAFQABANG-543")
	public void ContentTreeVerifictaionforLinksAvailableunderFreqlyAskQues() throws Exception {
		SoftAssert softas = new SoftAssert();
		HomePage homepage = this.homepage;
		try {
			testResult = Reporter.getCurrentTestResult();
			...
			String jiraNumber = testResult.getMethod().getDescription();
			String issueSummary = getIssueTitle(jiraNumber,
					"Content tree Validation for Links available under Frequently Asked Questions Widget - Todas Thematic dropdown");
			...
			for (Object searchString : listOfSearchData) {
				...
				boolean allLinksValidated = true;

				for (int row = 0; row < expectedlinks.size(); row++) {

					boolean contenttreevalidated = false;
					homepage.openHomepage();
					homepage.clickSeeMoreLinkInFreqAskQuesWidget();
					String currentLink = expectedlinks.get(row).toString();
					if (homepage.FreqAskQuesLinkDisplayed(currentLink)) {
						searchpage = homepage.ClickFreqAskQuesLink(currentLink);
						contenttreevalidated = searchpage.isLastLinkDisplayedInContentTreeEquals(currentLink);
						homepage = searchpage.clickHomeTab();
					}

					softas.assertTrue(contenttreevalidated, jiraNumber + ":" + issueSummary);
					logExtentStatus(extentLogger, contenttreevalidated, issueSummary, expectedlinksKey, currentLink,
							jiraNumber);

					allLinksValidated &= contenttreevalidated;
				}

				softas.assertTrue(allLinksValidated, jiraNumber + ":" + issueSummary);
				logExtentStatus(extentLogger, allLinksValidated, issueSummary, thematicareaKey, thematicarea,
						jiraNumber);
			}
	...
	@Test(priority = 33, groups = { "chppy", "chpury" }, description = "MAFQABANG-562")
	...
	@Test(priority = 34, groups = { "chppy", "chpury" }, description = "MAFQABANG-563")
	...
	@Test(priority = 25, groups = { "chppy", "chpury" }, description = "MAFQABANG-574")
	 ...
	 * re-login
	 */
	@Test(priority = 36, groups = { "chpury", "chppy" }, description = "MAFQABANG-573")
	 ...
	 * after re-login
	 */
	@Test(priority = 36, groups = { "chpury", "chppy" }, description = "MAFQABANG-576")
	...
	public void verifyUnitandRubricLink() throws Exception {
		...
		try {
			...
			for (Object searchString : listOfSearchData) {
				...
				softas.assertTrue(IsUnitRubricLinkDisplayed, "verify whether unit+rubric is a link" + ":" + jiraNumber);
