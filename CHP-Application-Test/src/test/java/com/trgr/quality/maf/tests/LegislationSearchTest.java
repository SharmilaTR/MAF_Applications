...
public class LegislationSearchTest extends BaseTest {
	 ...
	 */
	@Test(priority = 1, groups = { "chpmex", "chparg", "chpbr", "chppy", "chpury", "chppe",
	 ...
	 */
	@Test(priority = 2, groups = { "chparg", "chpmex", "chppy", "chpury", "chppe","chpchile" }, description = "MAFQABANG-61")
	...
	@Test(priority = 6, groups = { "chppy", "chpury", "chppe","chpchile" }, description = "MAFQABANG-62")
