...
public class DocumentDisplayTest extends BaseTest {
	...
	@Test(priority=0, groups = { "chparg", "chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-78")
...
//				searchpage.enterFreeWordOnSearchPage(freewordVal);
	...
	@Test(priority=1, groups = { "chparg",  "chpmex","chpury","chppy","chppe" },  description = "MAFQABANG-77")
	...
	@Test(priority=2, groups = {"chparg","chpmex","chpbr","chpury","chppy","chppe","chpchile"}, description = "MAFQABANG-80")
	...
	@Test(priority=3,   groups = {"chparg","chpmex","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-79")
	...
	@Test(priority=4, groups = { "chparg",  "chpmex", "chpbr","chpury","chppy","chpchile" }, description = "MAFQABANG-99")
...
//				homepage.clickFollowDocumentWidgetVermasLink();
	...
	@Test(priority=6, groups = {"chparg","chpmex","chpury","chppy" }, description = "MAFQABANG-104")
	 ...
	 */
	@Test(priority=7, groups = { "chparg",  "chpmex","chpury","chppy" }, description = "MAFQABANG-83")
	...
	@Test(priority=8, groups = { "chparg","chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-87")
	 ...
	 */
	@Test(priority = 9, groups = { "chparg","chpbr", "chppy","chppe","chpchile","chpmex" }, description = "MAFQABANG-105")
...
//				homepage.enterTextInSearchField(freewordVal);
	 ...
	 */
	/*@Test(priority=10, groups = {"chpmex","chppy","chpury","chppe","chpchile"}, description = "MAFQABANG-108")
	 ...
	 * Left Pane
	 */
	@Test(priority=11, groups = { "chparg",  "chpmex", "chpbr","chpury","chppy","chppe" }, description = "MAFQABANG-86")
	 ...
	 */
	@Test(priority=12,   groups = { "chparg",  "chpmex", "chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-102")
...
//				homepage.enterFreewordOnQuickSearch(freewordVal);
	...
	@Test(priority=22,   groups = { "chparg",  "chpmex", "chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-88")
...
//				searchpage.enterFreeWordOnSearchPage(freewordVal);
	...
	@Test(priority=23,   groups = { "chparg",  "chpmex", "chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-100")
	...
	public void deliveryUsingPrintAndExportOnDocDisplay() throws Exception {
		...
		try {
			...
			for (Object searchString : listOfSearchData) {
				...
				softas.assertTrue(deliverypage.deliverTextDisplayed(),"MAFAUTO-118:Verify print from docuemnt display with fulldocument (Doctrina)");
				logExtentStatus(extentLogger, deliverypage.deliverTextDisplayed(),"Verify print from docuemnt display with fulldocument (Doctrina)",jiraNumber);
	...
	public void withScrollValdiateHeaderTitle() throws Exception {
		...
		try {
			...
			for (Object searchString : listOfSearchData) {
				...
				documentdisplaypage.clickLeftPaneLink(linksavailable.get(2).toString());
