...
public class ContentTreeTest extends BaseTest {
	 ...
	 */
	@Test(priority = 1, groups = {"chparg", "chpmex", "chpbr","chpury","chppy","chppe","chpchile" },description="MAFQABANG-388")
	 ...
	 */
	@Test(priority = 2, groups = {"chparg", "chpmex", "chpbr","chpury","chppy","chppe","chpchile" },description="MAFQABANG-391")
	 ...
	 */
	@Test(priority = 3, groups = {"chparg", "chpmex", "chpbr","chpury","chppy","chppe","chpchile"},description="MAFQABANG-392")
