...
public class DeliveryTest extends BaseTest {
	...
	@Test(priority=0,groups = { "chparg", "chpmex", "chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-133")
...
//				searchpage.enterFreeWordOnSearchPage(freewordVal);
	...
	@Test(priority=1,groups = { "chparg", "chpmex", "chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-135")
...
//				searchpage.enterFreeWordOnSearchPage(freewordVal);
	...
	@Test(priority=2,groups = { "chparg", "chpmex", "chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-136")
...
//				searchpage.enterFreeWordOnSearchPage(freewordVal);
	...
	@Test(priority=21, groups = { "chparg", "chpmex", "chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-134")
...
//				searchpage.enterFreeWordOnSearchPage(freewordVal);
	 ...
	 * Delivery_TC_0011: Verify the export document in Result List
	 */
	@Test(priority=5,groups = { "chpmex", "chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-143")
...
//				searchpage.enterFreeWordOnSearchPage(freewordVal);
				...
				flag = deliverypage.verifyResultListExportPage()
	 ...
	 */
	@Test(priority=6,groups = { "chparg", "chpmex", "chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-144")
...
//				searchpage.enterFreeWordOnSearchPage(freewordVal);
	...
	@Test(priority=7,groups = { "chparg", "chpmex", "chpbr" ,"chpury","chppy","chppe","chpchile"}, description = "MAFQABANG-137")
	...
	@Test(priority=8, groups = { "chparg", "chpmex","chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-138")
	...
	@Test(priority=9, groups = { "chparg", "chpmex","chpbr","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-139")
	...
	@Test(priority=10,groups = { "chparg", "chpbr","chppy","chpury","chppe","chpchile" }, description = "MAFQABANG-140")
	...
	@Test(priority=12, groups = { "chparg", "chpbr" ,"chpury","chppy","chpmex","chppe","chpchile"}, description = "MAFQABANG-142")
...
//				}
	...
	@Test(priority=14, groups = {"chpmex","chpury","chppy","chppe","chpchile" }, description = "MAFQABANG-141")
