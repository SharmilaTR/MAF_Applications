...
public class MyDocumentTest extends BaseTest {
	...
	@Test(priority=0,groups = {"chparg","chpbr","chpury","chppy","chppe","chpchile"}, description="MAFQABANG-115")
	...
	@Test(priority=5,groups = {"chparg","chpury","chppy","chppe","chpchile"}, description="MAFQABANG-619")
	...
	@Test(priority=1,groups = { "chparg","chppy","chpury","chppe","chpchile" },description = "MAFQABANG-116")	
	...
	@Test(priority=2,groups = { "chparg","chpury","chppy","chppe","chpchile" },description = "MAFQABANG-117")	
