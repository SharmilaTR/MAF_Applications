...
public class ToolsTest extends BaseTest {
	...
	@Test(priority = 0, groups = { "chparg", "chpmex", "chpbr", "chppy", "chppe", "chpchile",
	...
	@Test(priority = 1, groups = { "chparg", "chpmex", "chpbr", "chppy", "chppe", "chpchile","chpury" }, description = "MAFQABANG-147")
	...
	@Test(priority = 2, groups = { "chparg", "chpmex", "chpbr", "chpury", "chppe","chpchile",
			"chppy" }, description = "MAFQABANG-149")
	...
	@Test(priority = 3, groups = { "chparg", "chpmex", "chpbr", "chppy", "chppe", "chpchile",
