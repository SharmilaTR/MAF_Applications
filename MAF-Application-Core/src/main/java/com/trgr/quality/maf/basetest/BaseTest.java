...
public class BaseTest {
	...
	public static void setup(@Optional String environment, @Optional String productToTest, @Optional String browser)
		...
		String username = PropertiesRepository.getString("com.trgr.maf." + BaseTest.productUnderTest + "." + Envirnomentundertest +".username");
		String password = PropertiesRepository.getString("com.trgr.maf." + BaseTest.productUnderTest + "." + Envirnomentundertest +".password");
		extentReports.addSystemInfo("Username:" + username, "Password:" +password);
	...
	public String getIssueTitle(String issueKey, String issueSummary) throws Exception {
		/*
		 * jiraConnect = new JiraConnector(); Issue issueHandle =
		 * jiraConnect.getIssue(issueKey);
		 * 
		 * if(issueHandle!=null) { String issueSummary =
		 * issueHandle.getSummary(); return issueSummary; }
		 */
		return issueSummary;
	}
